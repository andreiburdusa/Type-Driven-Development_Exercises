...
(define Chapter_11C-45Section_2C-45Exercises-totalREPL (lambda (arg-0 arg-1) (Chapter_11C-45Section_2C-45ArithTotal-C-62C-62 (PreludeC-45IO-putStr (csegen-13) arg-0) (lambda () (Chapter_11C-45Section_2C-45ArithTotal-C-62C-62C-61 (PreludeC-45IO-getLine (csegen-13)) (lambda (u--input) (lambda () (Chapter_11C-45Section_2C-45ArithTotal-C-62C-62 (PreludeC-45IO-putStr (csegen-13) (arg-1 u--input)) (lambda () (Chapter_11C-45Section_2C-45Exercises-totalREPL arg-0 arg-1))))))))))
...
(define Chapter_11C-45Section_2C-45ArithTotal-run (lambda (arg-0 arg-1) (if (null? arg-0) (PreludeC-45IO-putStrLn (csegen-13) "Out of fuel") (let ((e-0 (unbox arg-0))) (case (vector-ref arg-1 0) ((0) (let ((e-2 (vector-ref arg-1 1))) (let ((e-3 (vector-ref arg-1 2))) (lambda (eta-0) (let ((act-24 (e-2 eta-0))) ((Chapter_11C-45Section_2C-45ArithTotal-run (e-0) ((e-3 act-24))) eta-0)))))) (else (let ((e-4 (vector-ref arg-1 1))) (let ((e-5 (vector-ref arg-1 2))) (PreludeC-45Interfaces-C-62C-62 (vector (csegen-6) (csegen-9) (lambda (u--a) (lambda (arg-9634) (lambda (eta-0) (let ((act-29 (arg-9634 eta-0))) (act-29 eta-0)))))) e-4 (lambda () (Chapter_11C-45Section_2C-45ArithTotal-run (e-0) (e-5))))))))))))
(define Chapter_11C-45Section_2C-45ArithTotal-forever(blodwen-lazy (lambda () (box (lambda () (Chapter_11C-45Section_2C-45ArithTotal-forever))))))
(define Chapter_11C-45Section_2C-45ArithTotal-C-62C-62C-61 (lambda (ext-0 ext-1) (vector 0 ext-0 ext-1)))
(define Chapter_11C-45Section_2C-45ArithTotal-C-62C-62 (lambda (ext-0 ext-1) (vector 1 ext-0 ext-1)))
(load-shared-object "libidris2_support.so")
(collect-request-handler (lambda () (collect) (blodwen-run-finalisers)))
(PrimIO-unsafePerformIO (Chapter_11C-45Section_2C-45ArithTotal-run (Chapter_11C-45Section_2C-45ArithTotal-forever) (Chapter_11C-45Section_2C-45Exercises-totalREPL "\xa;: " (lambda (eta-0) (DataC-45String-toUpper eta-0)))))  (collect 4)
