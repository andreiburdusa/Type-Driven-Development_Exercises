...
(define Chapter_6C-45Section_3C-45DataStore-case--processInput-7726 (lambda (arg-0 arg-1 arg-2) (if (null? arg-2) (box (cons "Invalid command\xa;" arg-1)) (let ((e-2 (unbox arg-2))) (case (vector-ref e-2 0) ((1) (let ((e-4 (vector-ref e-2 1))) (box (cons (string-append "ID " (string-append (PreludeC-45Show-u--show_Show_Nat (let ((e-1 (vector-ref arg-1 1))) e-1)) "\xa;")) (Chapter_6C-45Section_3C-45DataStore-addToStore arg-1 e-4))))) ((0) (let ((e-6 (vector-ref e-2 1))) (let ((sc2 (Chapter_6C-45Section_3C-45DataStore-setSchema arg-1 e-6))) (if (null? sc2) (box (cons "Can't update schema\xa;" arg-1)) (let ((e-3 (unbox sc2))) (box (cons "OK\xa;" e-3))))))) ((2) (let ((e-8 (vector-ref e-2 1))) (if (null? e-8) (Chapter_6C-45Section_3C-45DataStore-getAll arg-1) (let ((e-12 (unbox e-8))) (Chapter_6C-45Section_3C-45DataStore-getEntry e-12 arg-1))))) (else '()))))))
(define Chapter_6C-45Section_3C-45DataStore-case--parsePrefix-7121 (lambda (arg-0 arg-1) (let ((e-2 (car arg-1))) (let ((e-3 (cdr arg-1))) (cond ((equal? e-2 "") '())(else (box (cons (PreludeC-45Cast-u--cast_Cast_String_Int e-2) (DataC-45String-ltrim e-3)))))))))
(define Chapter_6C-45Section_3C-45DataStore-n--4017-7150-u--worker (lambda (arg-0 arg-1) (if (null? arg-1) '() (let ((e-1 (car arg-1))) (let ((e-2 (cdr arg-1))) (box (cons e-1 (DataC-45String-ltrim (PreludeC-45Types-fastPack e-2)))))))))
(define Chapter_6C-45Section_3C-45DataStore-n--4623-7601-u--stringsC-39 (lambda (arg-0) (PreludeC-45Types-u--map_Functor_List (lambda (arg-1) (string-append ": " arg-1)) (Chapter_6C-45Section_3C-45DataStore-n--4623-7600-u--strings arg-0))))
(define Chapter_6C-45Section_3C-45DataStore-n--4623-7600-u--strings (lambda (arg-0) (PreludeC-45Types-u--map_Functor_List (lambda (eta-0) (Builtin-fst eta-0)) (Chapter_6C-45Section_3C-45DataStore-getJust (Chapter_6C-45Section_3C-45DataStore-n--4623-7599-u--partialResults arg-0)))))
(define Chapter_6C-45Section_3C-45DataStore-n--4623-7603-u--results (lambda (arg-0) (DataC-45List-u--zipWith_Zippable_List (lambda (eta-0) (lambda (eta-1) (string-append eta-0 eta-1))) (Chapter_6C-45Section_3C-45DataStore-n--4623-7602-u--indicesStrings arg-0) (Chapter_6C-45Section_3C-45DataStore-n--4623-7601-u--stringsC-39 arg-0))))
(define Chapter_6C-45Section_3C-45DataStore-n--4623-7599-u--partialResults (lambda (arg-0) (PreludeC-45Types-u--map_Functor_List (lambda (u--pos) (Chapter_6C-45Section_3C-45DataStore-getEntry u--pos arg-0)) (Chapter_6C-45Section_3C-45DataStore-n--4623-7598-u--indices arg-0))))
(define Chapter_6C-45Section_3C-45DataStore-n--4623-7602-u--indicesStrings (lambda (arg-0) (PreludeC-45Types-u--map_Functor_List (lambda (eta-0) (PreludeC-45Show-u--show_Show_Nat eta-0)) (PreludeC-45Types-u--rangeFromTo_Range_Nat 1 (let ((e-1 (vector-ref arg-0 1))) e-1)))))
(define Chapter_6C-45Section_3C-45DataStore-n--4623-7598-u--indices (lambda (arg-0) (PreludeC-45Types-u--rangeFromThenTo_Range_C-36a (cons (vector (csegen-3) (lambda (arg-5864) (lambda (arg-5867) (PreludeC-45Num-u--div_Integral_Integer arg-5864 arg-5867))) (lambda (arg-5874) (lambda (arg-5877) (PreludeC-45Num-u--mod_Integral_Integer arg-5874 arg-5877)))) (cons (vector (cons (lambda (arg-528) (lambda (arg-531) (PreludeC-45EqOrd-u--C-61C-61_Eq_Integer arg-528 arg-531))) (lambda (arg-538) (lambda (arg-541) (PreludeC-45EqOrd-u--C-47C-61_Eq_Integer arg-538 arg-541)))) (lambda (arg-1418) (lambda (arg-1421) (PreludeC-45EqOrd-u--compare_Ord_Integer arg-1418 arg-1421))) (lambda (arg-1428) (lambda (arg-1431) (PreludeC-45EqOrd-u--C-60_Ord_Integer arg-1428 arg-1431))) (lambda (arg-1438) (lambda (arg-1441) (PreludeC-45EqOrd-u--C-62_Ord_Integer arg-1438 arg-1441))) (lambda (arg-1448) (lambda (arg-1451) (PreludeC-45EqOrd-u--C-60C-61_Ord_Integer arg-1448 arg-1451))) (lambda (arg-1458) (lambda (arg-1461) (PreludeC-45EqOrd-u--C-62C-61_Ord_Integer arg-1458 arg-1461))) (lambda (arg-1468) (lambda (arg-1471) (PreludeC-45EqOrd-u--max_Ord_Integer arg-1468 arg-1471))) (lambda (arg-1478) (lambda (arg-1481) (PreludeC-45EqOrd-u--min_Ord_Integer arg-1478 arg-1481)))) (vector (csegen-3) (lambda (arg-5595) (- 0 arg-5595)) (lambda (arg-5601) (lambda (arg-5604) (- arg-5601 arg-5604)))))) 0 1 (- (let ((e-1 (vector-ref arg-0 1))) e-1) 1))))
(define Chapter_6C-45Section_3C-45DataStore-n--4017-7058-u--getQuoted (lambda (arg-0 arg-1) (if (null? arg-1) '() (let ((e-1 (car arg-1))) (let ((e-2 (cdr arg-1))) (cond ((equal? e-1 #\") (let ((sc2 (DataC-45List-span (lambda (arg-2) (PreludeC-45EqOrd-u--C-47C-61_Eq_Char arg-2 #\")) e-2))) (if (null? sc2) '() (let ((e-4 (car sc2))) (let ((e-3 (cdr sc2))) (if (null? e-3) '() (let ((e-5 (car e-3))) (let ((e-6 (cdr e-3))) (cond ((equal? e-5 #\") (box (cons (PreludeC-45Types-fastPack e-4) (DataC-45String-ltrim (PreludeC-45Types-fastPack e-6)))))(else '()))))))))))(else '())))))))
(define Chapter_6C-45Section_3C-45DataStore-n--4452-7450-u--addToData (lambda (arg-0 arg-1 arg-2 arg-3 arg-5) (if (null? arg-5) (cons arg-3 '()) (let ((e-3 (car arg-5))) (let ((e-4 (cdr arg-5))) (cons e-3 (Chapter_6C-45Section_3C-45DataStore-n--4452-7450-u--addToData arg-0 arg-1 arg-2 arg-3 e-4)))))))
(define Chapter_6C-45Section_3C-45DataStore-setSchema (lambda (arg-0 arg-1) (let ((sc0 (let ((e-1 (vector-ref arg-0 1))) e-1))) (cond ((equal? sc0 0) (box (vector arg-1 0 '())))(else '())))))
(define Chapter_6C-45Section_3C-45DataStore-processInput (lambda (arg-0 arg-1) (Chapter_6C-45Section_3C-45DataStore-case--processInput-7726 arg-1 arg-0 (Chapter_6C-45Section_3C-45DataStore-parse (let ((e-0 (vector-ref arg-0 0))) e-0) arg-1))))
(define Chapter_6C-45Section_3C-45DataStore-parseSchema (lambda (arg-0) (if (null? arg-0) '() (let ((e-1 (car arg-0))) (let ((e-2 (cdr arg-0))) (cond ((equal? e-1 "String") (if (null? e-2) (box (vector 0 )) (PreludeC-45Types-u--C-62C-62C-61_Monad_Maybe (Chapter_6C-45Section_3C-45DataStore-parseSchema e-2) (lambda (u--xs_sch) (box (vector 3 (vector 0 ) u--xs_sch)))))) ((equal? e-1 "Int") (if (null? e-2) (box (vector 1 )) (PreludeC-45Types-u--C-62C-62C-61_Monad_Maybe (Chapter_6C-45Section_3C-45DataStore-parseSchema e-2) (lambda (u--xs_sch) (box (vector 3 (vector 1 ) u--xs_sch)))))) ((equal? e-1 "Char") (if (null? e-2) (box (vector 2 )) (PreludeC-45Types-u--C-62C-62C-61_Monad_Maybe (Chapter_6C-45Section_3C-45DataStore-parseSchema e-2) (lambda (u--xs_sch) (box (vector 3 (vector 2 ) u--xs_sch))))))(else '())))))))
(define Chapter_6C-45Section_3C-45DataStore-parsePrefix (lambda (arg-0 arg-1) (case (vector-ref arg-0 0) ((0) (Chapter_6C-45Section_3C-45DataStore-n--4017-7058-u--getQuoted arg-1 (PreludeC-45Types-fastUnpack arg-1))) ((1) (Chapter_6C-45Section_3C-45DataStore-case--parsePrefix-7121 arg-1 (DataC-45String-span (lambda (eta-0) (PreludeC-45Types-isDigit eta-0)) arg-1))) ((2) (Chapter_6C-45Section_3C-45DataStore-n--4017-7150-u--worker arg-1 (PreludeC-45Types-fastUnpack arg-1))) (else (let ((e-0 (vector-ref arg-0 1))) (let ((e-1 (vector-ref arg-0 2))) (PreludeC-45Types-u--C-62C-62C-61_Monad_Maybe (Chapter_6C-45Section_3C-45DataStore-parsePrefix e-0 arg-1) (lambda (_-0) (let ((e-2 (car _-0))) (let ((e-3 (cdr _-0))) (PreludeC-45Types-u--C-62C-62C-61_Monad_Maybe (Chapter_6C-45Section_3C-45DataStore-parsePrefix e-1 e-3) (lambda (_-1) (let ((e-5 (car _-1))) (let ((e-4 (cdr _-1))) (box (cons (cons e-2 e-5) e-4))))))))))))))))
(define Chapter_6C-45Section_3C-45DataStore-parseCommand (lambda (arg-0 arg-1 arg-2) (cond ((equal? arg-1 "add") (let ((sc1 (Chapter_6C-45Section_3C-45DataStore-parseBySchema arg-0 arg-2))) (if (null? sc1) '() (let ((e-2 (unbox sc1))) (box (vector 1 e-2)))))) ((equal? arg-1 "get") (cond ((equal? arg-2 "") (box (vector 2 '())))(else (let ((sc1 (PreludeC-45Interfaces-all (csegen-40) (lambda (eta-0) (PreludeC-45Types-isDigit eta-0)) (PreludeC-45Types-fastUnpack arg-2)))) (cond ((equal? sc1 0) '()) (else (box (vector 2 (box (PreludeC-45Cast-u--cast_Cast_String_Integer arg-2)))))))))) ((equal? arg-1 "quit") (cond ((equal? arg-2 "") (box (vector 3 )))(else '()))) ((equal? arg-1 "schema") (PreludeC-45Types-u--C-62C-62C-61_Monad_Maybe (Chapter_6C-45Section_3C-45DataStore-parseSchema (DataC-45String-words arg-2)) (lambda (u--schemaOk) (box (vector 0 u--schemaOk)))))(else '()))))
(define Chapter_6C-45Section_3C-45DataStore-parseBySchema (lambda (arg-0 arg-1) (let ((sc0 (Chapter_6C-45Section_3C-45DataStore-parsePrefix arg-0 arg-1))) (if (null? sc0) '() (let ((e-1 (unbox sc0))) (if (null? e-1) '() (let ((e-4 (car e-1))) (let ((e-5 (cdr e-1))) (cond ((equal? e-5 "") (box e-4))(else '()))))))))))
(define Chapter_6C-45Section_3C-45DataStore-parse (lambda (arg-0 arg-1) (let ((sc0 (DataC-45String-span (lambda (arg-2) (PreludeC-45EqOrd-u--C-47C-61_Eq_Char arg-2 #\ )) arg-1))) (let ((e-2 (car sc0))) (let ((e-3 (cdr sc0))) (Chapter_6C-45Section_3C-45DataStore-parseCommand arg-0 e-2 (DataC-45String-ltrim e-3)))))))
(define Chapter_6C-45Section_3C-45DataStore-main(blodwen-lazy (lambda () (SystemC-45REPL-replWith (cons (vector (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8437) (lambda (eta-0) (PreludeC-45IO-u--map_Functor_IO u--func arg-8437 eta-0)))))) (lambda (u--a) (lambda (arg-9139) (lambda (eta-0) arg-9139))) (lambda (u--b) (lambda (u--a) (lambda (arg-9145) (lambda (arg-9152) (lambda (eta-0) (let ((act-17 (arg-9145 eta-0))) (let ((act-16 (arg-9152 eta-0))) (act-17 act-16))))))))) (lambda (u--b) (lambda (u--a) (lambda (arg-9620) (lambda (arg-9623) (lambda (eta-0) (let ((act-24 (arg-9620 eta-0))) ((arg-9623 act-24) eta-0))))))) (lambda (u--a) (lambda (arg-9634) (lambda (eta-0) (let ((act-51 (arg-9634 eta-0))) (act-51 eta-0)))))) (lambda (u--a) (lambda (arg-10871) arg-10871))) (vector (vector 3 (vector 0 ) (vector 3 (vector 0 ) (vector 1 ))) 0 '()) "Command: " (lambda (eta-0) (lambda (eta-1) (Chapter_6C-45Section_3C-45DataStore-processInput eta-0 eta-1)))))))
(define Chapter_6C-45Section_3C-45DataStore-getJust (lambda (arg-1) (if (null? arg-1) '() (let ((e-2 (car arg-1))) (let ((e-3 (cdr arg-1))) (if (null? e-2) (Chapter_6C-45Section_3C-45DataStore-getJust e-3) (let ((e-6 (unbox e-2))) (cons e-6 (Chapter_6C-45Section_3C-45DataStore-getJust e-3)))))))))
(define Chapter_6C-45Section_3C-45DataStore-getEntry (lambda (arg-0 arg-1) (let ((u--store_items (let ((e-2 (vector-ref arg-1 2))) e-2))) (let ((sc0 (DataC-45Fin-integerToFin arg-0 (let ((e-1 (vector-ref arg-1 1))) e-1)))) (if (null? sc0) (box (cons "Out of range\xa;" arg-1)) (let ((e-2 (unbox sc0))) (box (cons (string-append (Chapter_6C-45Section_3C-45DataStore-display (let ((e-0 (vector-ref arg-1 0))) e-0) (DataC-45Vect-index e-2 u--store_items)) "\xa;") arg-1))))))))
(define Chapter_6C-45Section_3C-45DataStore-getAll (lambda (arg-0) (box (cons (PreludeC-45Interfaces-concat (cons (lambda (arg-8026) (lambda (arg-8029) (string-append arg-8026 arg-8029))) "") (csegen-40) (Chapter_6C-45Section_3C-45DataStore-n--4623-7603-u--results arg-0)) arg-0))))
(define Chapter_6C-45Section_3C-45DataStore-display (lambda (arg-0 arg-1) (case (vector-ref arg-0 0) ((0) (PreludeC-45Show-u--show_Show_String arg-1)) ((1) (PreludeC-45Show-u--show_Show_Int arg-1)) ((2) (PreludeC-45Show-u--show_Show_Char arg-1)) (else (let ((e-0 (vector-ref arg-0 1))) (let ((e-1 (vector-ref arg-0 2))) (let ((e-4 (car arg-1))) (let ((e-5 (cdr arg-1))) (string-append (Chapter_6C-45Section_3C-45DataStore-display e-0 e-4) (string-append ", " (Chapter_6C-45Section_3C-45DataStore-display e-1 e-5)))))))))))
(define Chapter_6C-45Section_3C-45DataStore-addToStore (lambda (arg-0 arg-1) (let ((e-0 (vector-ref arg-0 0))) (let ((e-1 (vector-ref arg-0 1))) (let ((e-2 (vector-ref arg-0 2))) (vector e-0 (+ e-1 1) (Chapter_6C-45Section_3C-45DataStore-n--4452-7450-u--addToData e-1 e-0 e-2 arg-1 e-2)))))))
...
(define DataC-45String-n--3098-3347-u--wordsHelper (lambda (arg-0 arg-1 arg-2) (if (null? arg-1) arg-2 (cons arg-2 (DataC-45SnocList-C-60C-62C-62 arg-1 '())))))
(define DataC-45String-n--3098-3348-u--wordsC-39 (lambda (arg-0 arg-1 arg-2 arg-3) (if (null? arg-1) (DataC-45SnocList-C-60C-62C-62 (DataC-45String-n--3098-3347-u--wordsHelper arg-0 arg-2 arg-3) '()) (let ((e-1 (car arg-1))) (let ((e-2 (cdr arg-1))) (let ((sc1 (PreludeC-45Types-isSpace e-1))) (cond ((equal? sc1 1) (DataC-45String-n--3098-3348-u--wordsC-39 arg-0 e-2 '() (DataC-45String-n--3098-3347-u--wordsHelper arg-0 arg-2 arg-3))) (else (DataC-45String-n--3098-3348-u--wordsC-39 arg-0 e-2 (cons arg-2 e-1) arg-3)))))))))
(define DataC-45String-words (lambda (arg-0) (PreludeC-45Types-u--map_Functor_List (lambda (eta-0) (PreludeC-45Types-fastPack eta-0)) (DataC-45String-n--3098-3348-u--wordsC-39 arg-0 (PreludeC-45Types-fastUnpack arg-0) '() '()))))
...
(define DataC-45SnocList-C-60C-62C-62 (lambda (arg-1 arg-2) (if (null? arg-1) arg-2 (let ((e-2 (car arg-1))) (let ((e-3 (cdr arg-1))) (DataC-45SnocList-C-60C-62C-62 e-2 (cons e-3 arg-2)))))))
...
(define PreludeC-45Types-u--rangeFromThenTo_Range_C-36a (lambda (arg-1 arg-2 arg-3 arg-4) (let ((sc0 (let ((sc1 (Builtin-fst (Builtin-snd arg-1)))) (let ((e-2 (vector-ref sc1 1))) ((e-2 (let ((sc1 (Builtin-snd (Builtin-snd arg-1)))) (let ((e-9 (vector-ref sc1 2))) ((e-9 arg-4) arg-2)))) (let ((sc1 (Builtin-snd (Builtin-snd arg-1)))) (let ((e-9 (vector-ref sc1 2))) ((e-9 arg-4) arg-3)))))))) (cond ((equal? sc0 0) (PreludeC-45Types-takeBefore (lambda (arg-0) (let ((sc1 (Builtin-fst (Builtin-snd arg-1)))) (let ((e-3 (vector-ref sc1 2))) ((e-3 arg-0) arg-4)))) (PreludeC-45Types-countFrom arg-2 (lambda (u--n) (let ((sc1 (Builtin-snd (Builtin-snd arg-1)))) (let ((e-3 (vector-ref sc1 2))) ((e-3 u--n) (let ((sc1 (Builtin-snd (Builtin-snd arg-1)))) (let ((e-4 (vector-ref sc1 2))) ((e-4 arg-2) arg-3)))))))))) ((equal? sc0 1) (let ((sc1 (let ((sc2 (let ((sc3 (Builtin-fst (Builtin-snd arg-1)))) (let ((e-1 (vector-ref sc3 0))) (let ((e-10 (car e-1))) ((e-10 arg-2) arg-3)))))) (cond ((equal? sc2 1) (let ((sc3 (Builtin-fst (Builtin-snd arg-1)))) (let ((e-1 (vector-ref sc3 0))) (let ((e-10 (car e-1))) ((e-10 arg-3) arg-4))))) (else 0))))) (cond ((equal? sc1 1) (PreludeC-45Types-u--pure_Applicative_List arg-2)) (else '())))) (else (PreludeC-45Types-takeBefore (lambda (arg-0) (let ((sc1 (Builtin-fst (Builtin-snd arg-1)))) (let ((e-4 (vector-ref sc1 3))) ((e-4 arg-0) arg-4)))) (PreludeC-45Types-countFrom arg-2 (lambda (arg-0) (let ((sc1 (Builtin-snd (Builtin-snd arg-1)))) (let ((e-1 (vector-ref sc1 0))) (let ((e-6 (vector-ref e-1 0))) ((e-6 arg-0) (let ((sc1 (Builtin-snd (Builtin-snd arg-1)))) (let ((e-7 (vector-ref sc1 2))) ((e-7 arg-3) arg-2)))))))))))))))
...
(define PreludeC-45Types-takeBefore (lambda (arg-1 arg-2) (let ((e-1 (car arg-2))) (let ((e-2 (cdr arg-2))) (let ((sc1 (arg-1 e-1))) (cond ((equal? sc1 1) '()) (else (cons e-1 (PreludeC-45Types-takeBefore arg-1 (e-2))))))))))
...
(define PreludeC-45Num-u--mod_Integral_Integer (lambda (arg-0 arg-1) (let ((sc0 (PreludeC-45EqOrd-u--C-61C-61_Eq_Integer arg-1 0))) (cond ((equal? sc0 0) (remainder arg-0 arg-1))(else ((Builtin-idris_crash 'erased) "Unhandled input for Prelude.Num.case block in mod at Prelude.Num:84:3--86:44"))))))
(define PreludeC-45Num-u--div_Integral_Integer (lambda (arg-0 arg-1) (let ((sc0 (PreludeC-45EqOrd-u--C-61C-61_Eq_Integer arg-1 0))) (cond ((equal? sc0 0) (quotient arg-0 arg-1))(else ((Builtin-idris_crash 'erased) "Unhandled input for Prelude.Num.case block in div at Prelude.Num:81:3--83:44"))))))
...
(define PreludeC-45Show-n--2326-9707-u--asciiTab (lambda (arg-0) (cons "NUL" (cons "SOH" (cons "STX" (cons "ETX" (cons "EOT" (cons "ENQ" (cons "ACK" (cons "BEL" (cons "BS" (cons "HT" (cons "LF" (cons "VT" (cons "FF" (cons "CR" (cons "SO" (cons "SI" (cons "DLE" (cons "DC1" (cons "DC2" (cons "DC3" (cons "DC4" (cons "NAK" (cons "SYN" (cons "ETB" (cons "CAN" (cons "EM" (cons "SUB" (cons "ESC" (cons "FS" (cons "GS" (cons "RS" (cons "US" '()))))))))))))))))))))))))))))))))))
...
(PrimIO-unsafePerformIO (Chapter_6C-45Section_3C-45DataStore-main))  (collect 4)
