...
(define Chapter_11C-45Section_1C-45Arith-with--arithInputsC-44bound-1297 (lambda (arg-0 arg-1 arg-2) (let ((e-2 (vector-ref arg-2 2))) (bs+ e-2 1 63))))
(define Chapter_11C-45Section_1C-45Arith-n--3561-1286-u--bound (lambda (arg-0 arg-1) (Chapter_11C-45Section_1C-45Arith-with--arithInputsC-44bound-1297 arg-0 arg-1 (DataC-45PrimitivesC-45ViewsC-45IntV-divides arg-1 12))))
(define Chapter_11C-45Section_1C-45Arith-randoms (lambda (arg-0) (let ((u--seedC-39 (bs+ (bs* (blodwen-toSignedInt 1664525 63) arg-0 63) (blodwen-toSignedInt 1013904223 63) 63))) (cons (blodwen-shr u--seedC-39 (PreludeC-45Cast-u--cast_Cast_Nat_Int 2)) (lambda () (Chapter_11C-45Section_1C-45Arith-randoms u--seedC-39))))))
(define Chapter_11C-45Section_1C-45Arith-quiz (lambda (arg-0 arg-1) (let ((e-1 (car arg-0))) (let ((e-2 (cdr arg-0))) (let ((e-4 (e-2))) (let ((e-6 (car e-4))) (let ((e-7 (cdr e-4))) (PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStrLn (csegen-16) (string-append "Score so far: " (PreludeC-45Show-u--show_Show_Nat arg-1))) (lambda () (PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStr (csegen-16) (string-append (PreludeC-45Show-u--show_Show_Int e-1) (string-append " * " (string-append (PreludeC-45Show-u--show_Show_Int e-6) "? ")))) (lambda () (lambda (eta-0) (let ((act-24 ((PreludeC-45IO-getLine (csegen-16)) eta-0))) (let ((sc2 (PreludeC-45EqOrd-u--C-61C-61_Eq_Int (PreludeC-45Cast-u--cast_Cast_String_Int act-24) (bs* e-1 e-6 63)))) (cond ((equal? sc2 1) ((PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStrLn (csegen-16) "Correct!") (lambda () (Chapter_11C-45Section_1C-45Arith-quiz (e-7) (+ arg-1 1)))) eta-0)) (else ((PreludeC-45Interfaces-C-62C-62 (csegen-12) (PreludeC-45IO-putStrLn (csegen-16) (string-append "Wrong, the answer is " (PreludeC-45Show-u--show_Show_Int (bs* e-1 e-6 63)))) (lambda () (Chapter_11C-45Section_1C-45Arith-quiz (e-7) arg-1))) eta-0)))))))))))))))))
(define Chapter_11C-45Section_1C-45Arith-arithInputs (lambda (arg-0) (PreludeC-45Types-u--map_Functor_Stream (lambda (eta-0) (Chapter_11C-45Section_1C-45Arith-n--3561-1286-u--bound arg-0 eta-0)) (Chapter_11C-45Section_1C-45Arith-randoms arg-0))))
...
(define PreludeC-45Num-u--__Impl_Num_Int(blodwen-lazy (lambda () (vector (lambda (arg-5476) (lambda (arg-5479) (bs+ arg-5476 arg-5479 63))) (lambda (arg-5486) (lambda (arg-5489) (bs* arg-5486 arg-5489 63))) (lambda (arg-5496) (blodwen-toSignedInt arg-5496 63))))))
...
(PrimIO-unsafePerformIO (Chapter_11C-45Section_1C-45Arith-quiz (Chapter_11C-45Section_1C-45Arith-arithInputs (PreludeC-45Num-fromInteger (PreludeC-45Num-u--__Impl_Num_Int) 12345)) 0))  (collect 4)
