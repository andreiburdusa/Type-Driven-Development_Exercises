...
(define csegen-0(blodwen-lazy (lambda () (Chapter_11C-45Section_3C-45ArithCmd-C-62C-62C-61 (vector 0 "Error while reading command\xa;") (lambda (u--_) (lambda () (Chapter_11C-45Section_3C-45ArithCmd-shell)))))))
(define csegen-14(blodwen-lazy (lambda () (cons (vector (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8437) (lambda (eta-0) (PreludeC-45IO-u--map_Functor_IO u--func arg-8437 eta-0)))))) (lambda (u--a) (lambda (arg-9139) (lambda (eta-0) arg-9139))) (lambda (u--b) (lambda (u--a) (lambda (arg-9145) (lambda (arg-9152) (lambda (eta-0) (let ((act-17 (arg-9145 eta-0))) (let ((act-16 (arg-9152 eta-0))) (act-17 act-16))))))))) (lambda (u--b) (lambda (u--a) (lambda (arg-9620) (lambda (arg-9623) (lambda (eta-0) (let ((act-24 (arg-9620 eta-0))) ((arg-9623 act-24) eta-0))))))) (lambda (u--a) (lambda (arg-9634) (lambda (eta-0) (let ((act-51 (arg-9634 eta-0))) (act-51 eta-0)))))) (lambda (u--a) (lambda (arg-10871) arg-10871))))))
(define csegen-17(blodwen-lazy (lambda () (Chapter_11C-45Section_3C-45ArithCmd-C-62C-62C-61 (vector 0 "Error while reading file\xa;") (lambda (u--_) (lambda () (Chapter_11C-45Section_3C-45ArithCmd-shell)))))))
...
(define Chapter_11C-45Section_3C-45ArithCmd-shell(blodwen-lazy (lambda () (Chapter_11C-45Section_3C-45ArithCmd-C-62C-62 (vector 0 "$> ") (lambda () (Chapter_11C-45Section_3C-45ArithCmd-C-62C-62C-61 (vector 1 ) (lambda (u--command) (let ((sc0 (DataC-45String-words u--command))) (if (null? sc0) (lambda () (Chapter_11C-45Section_3C-45ArithCmd-shell)) (let ((e-1 (car sc0))) (let ((e-2 (cdr sc0))) (cond ((equal? e-1 "exit") (if (null? e-2) (lambda () (vector 0 (vector 0 ))) (lambda () (csegen-0)))) ((equal? e-1 "copy") (if (null? e-2) (lambda () (csegen-0)) (let ((e-6 (car e-2))) (let ((e-7 (cdr e-2))) (if (null? e-7) (lambda () (csegen-0)) (let ((e-9 (car e-7))) (let ((e-10 (cdr e-7))) (if (null? e-10) (lambda () (Chapter_11C-45Section_3C-45ArithCmd-copy e-6 e-9)) (lambda () (csegen-0)))))))))) ((equal? e-1 "cat") (if (null? e-2) (lambda () (csegen-0)) (let ((e-13 (car e-2))) (let ((e-14 (cdr e-2))) (if (null? e-14) (lambda () (Chapter_11C-45Section_3C-45ArithCmd-cat e-13)) (lambda () (csegen-0)))))))(else (lambda () (csegen-0)))))))))))))))
(define Chapter_11C-45Section_3C-45ArithCmd-runCommand (lambda (arg-1) (case (vector-ref arg-1 0) ((0) (let ((e-0 (vector-ref arg-1 1))) (PreludeC-45IO-putStr (csegen-14) e-0))) ((1) (PreludeC-45IO-getLine (csegen-14))) ((2) (let ((e-1 (vector-ref arg-1 1))) (SystemC-45FileC-45ReadWrite-readFile (csegen-14) e-1))) (else (let ((e-2 (vector-ref arg-1 1))) (let ((e-3 (vector-ref arg-1 2))) (SystemC-45FileC-45ReadWrite-writeFile (csegen-14) e-2 e-3)))))))
(define Chapter_11C-45Section_3C-45ArithCmd-run (lambda (arg-1 arg-2 ext-0) (case (vector-ref arg-2 0) ((0) (let ((e-6 (vector-ref arg-2 1))) (box e-6)))(else (if (null? arg-1) '() (let ((e-0 (unbox arg-1))) (let ((e-3 (vector-ref arg-2 1))) (let ((e-4 (vector-ref arg-2 2))) (let ((act-24 ((Chapter_11C-45Section_3C-45ArithCmd-runCommand e-3) ext-0))) (Chapter_11C-45Section_3C-45ArithCmd-run (e-0) ((e-4 act-24)) ext-0))))))))))
(define Chapter_11C-45Section_3C-45ArithCmd-mainShell (lambda (ext-0) (let ((act-24 (Chapter_11C-45Section_3C-45ArithCmd-run (Chapter_11C-45Section_3C-45ArithCmd-forever) (Chapter_11C-45Section_3C-45ArithCmd-shell) ext-0))) (if (null? act-24) ((PreludeC-45IO-putStrLn (csegen-14) "Ran out of fuel") ext-0) (vector 0 )))))
(define Chapter_11C-45Section_3C-45ArithCmd-forever(blodwen-lazy (lambda () (box (lambda () (Chapter_11C-45Section_3C-45ArithCmd-forever))))))
(define Chapter_11C-45Section_3C-45ArithCmd-copy (lambda (arg-0 arg-1) (Chapter_11C-45Section_3C-45ArithCmd-C-62C-62C-61 (vector 2 arg-0) (lambda (_-0) (case (vector-ref _-0 0) ((1) (let ((e-2 (vector-ref _-0 1))) (lambda () (Chapter_11C-45Section_3C-45ArithCmd-C-62C-62C-61 (vector 3 arg-1 e-2) (lambda (u--_) (lambda () (Chapter_11C-45Section_3C-45ArithCmd-shell))))))) (else (lambda () (csegen-17))))))))
(define Chapter_11C-45Section_3C-45ArithCmd-cat (lambda (arg-0) (Chapter_11C-45Section_3C-45ArithCmd-C-62C-62C-61 (vector 2 arg-0) (lambda (_-0) (case (vector-ref _-0 0) ((1) (let ((e-2 (vector-ref _-0 1))) (lambda () (Chapter_11C-45Section_3C-45ArithCmd-C-62C-62C-61 (vector 0 e-2) (lambda (u--_) (lambda () (Chapter_11C-45Section_3C-45ArithCmd-shell))))))) (else (lambda () (csegen-17))))))))
(define Chapter_11C-45Section_3C-45ArithCmd-C-62C-62C-61 (lambda (ext-0 ext-1) (vector 1 ext-0 ext-1)))
(define Chapter_11C-45Section_3C-45ArithCmd-C-62C-62 (lambda (arg-1 arg-2) (vector 1 arg-1 (lambda (_-901) arg-2))))
...
(define SystemC-45FileC-45ReadWrite-readLinesOnto (lambda (arg-1 arg-2 arg-3 arg-4 arg-5) (if (null? arg-4) (let ((e-1 (car arg-1))) (let ((e-5 (vector-ref e-1 0))) (let ((e-7 (vector-ref e-5 1))) ((e-7 'erased) (vector 1 (cons 0 (PreludeC-45TypesC-45List-reverse arg-2))))))) (let ((e-0 (unbox arg-4))) (let ((e-1 (car arg-1))) (let ((e-4 (vector-ref e-1 1))) ((((e-4 'erased) 'erased) (SystemC-45FileC-45ReadWrite-fEOF arg-1 arg-5)) (lambda (_-0) (cond ((equal? _-0 0) (cond ((equal? arg-3 0) (PreludeC-45InterfacesC-45Monad-u--C-62C-62C-61_Monad_ComposeC-40C-40C-46C-32C-36mC-41C-32C-36tC-41 (cons (let ((e-7 (car arg-1))) e-7) (cons (vector (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8437) (case (vector-ref arg-8437 0) ((0) (let ((e-6 (vector-ref arg-8437 1))) (vector 0 e-6))) (else (let ((e-6 (vector-ref arg-8437 1))) (vector 1 (u--func e-6))))))))) (lambda (u--a) (lambda (arg-9139) (vector 1 arg-9139))) (lambda (u--b) (lambda (u--a) (lambda (arg-9145) (lambda (arg-9152) (case (vector-ref arg-9145 0) ((0) (let ((e-6 (vector-ref arg-9145 1))) (vector 0 e-6))) (else (let ((e-6 (vector-ref arg-9145 1))) (case (vector-ref arg-9152 0) ((1) (let ((e-8 (vector-ref arg-9152 1))) (vector 1 (e-6 e-8)))) (else (let ((e-11 (vector-ref arg-9152 1))) (vector 0 e-11)))))))))))) (lambda (u--b) (lambda (u--a) (lambda (arg-9620) (lambda (arg-9623) (PreludeC-45Types-u--C-62C-62C-61_Monad_C-40EitherC-32C-36eC-41 arg-9620 arg-9623))))) (lambda (u--a) (lambda (arg-9634) (PreludeC-45Types-u--join_Monad_C-40EitherC-32C-36eC-41 arg-9634)))) (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8437) (case (vector-ref arg-8437 0) ((0) (let ((e-6 (vector-ref arg-8437 1))) (vector 0 e-6))) (else (let ((e-6 (vector-ref arg-8437 1))) (vector 1 (u--func e-6))))))))) (vector (lambda (u--acc) (lambda (u--elem) (lambda (u--func) (lambda (u--init) (lambda (u--input) (PreludeC-45Types-u--foldr_Foldable_C-40EitherC-32C-36eC-41 u--func u--init u--input)))))) (lambda (u--elem) (lambda (u--acc) (lambda (u--func) (lambda (u--init) (lambda (u--input) (PreludeC-45Types-u--foldl_Foldable_C-40EitherC-32C-36eC-41 u--func u--init u--input)))))) (lambda (u--elem) (lambda (arg-10120) (PreludeC-45Types-u--null_Foldable_C-40EitherC-32C-36eC-41 arg-10120))) (lambda (u--elem) (lambda (u--acc) (lambda (u--m) (lambda (i_con-0) (lambda (u--funcM) (lambda (u--init) (lambda (u--input) (PreludeC-45Types-u--foldlM_Foldable_C-40EitherC-32C-36eC-41 i_con-0 u--funcM u--init u--input)))))))) (lambda (u--elem) (lambda (arg-10149) (PreludeC-45Types-u--toList_Foldable_C-40EitherC-32C-36eC-41 arg-10149))) (lambda (u--a) (lambda (u--m) (lambda (i_con-0) (lambda (u--f) (lambda (arg-10163) (PreludeC-45Types-u--foldMap_Foldable_C-40EitherC-32C-36eC-41 i_con-0 u--f arg-10163))))))) (lambda (u--b) (lambda (u--a) (lambda (u--f) (lambda (i_con-0) (lambda (arg-12669) (lambda (arg-12676) (PreludeC-45Types-u--traverse_Traversable_C-40EitherC-32C-36eC-41 i_con-0 arg-12669 arg-12676)))))))))) (SystemC-45FileC-45ReadWrite-fGetLine arg-1 arg-5) (lambda (u--str) (SystemC-45FileC-45ReadWrite-readLinesOnto arg-1 (cons u--str arg-2) 0 (e-0) arg-5))))(else (let ((e-6 (- arg-3 1))) (PreludeC-45Interfaces-C-42C-62 (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8437) (PreludeC-45InterfacesC-45Functor-u--map_Functor_ComposeC-40C-40C-46C-32C-36fC-41C-32C-36gC-41 (cons (let ((sc3 (Builtin-fst (cons (let ((e-8 (car arg-1))) (let ((e-11 (vector-ref e-8 0))) e-11)) (vector (lambda (b-0) (lambda (a-0) (lambda (func-0) (lambda (arg-8438) (case (vector-ref arg-8438 0) ((0) (let ((e-7 (vector-ref arg-8438 1))) (vector 0 e-7))) (else (let ((e-7 (vector-ref arg-8438 1))) (vector 1 (func-0 e-7))))))))) (lambda (a-0) (lambda (arg-9139) (vector 1 arg-9139))) (lambda (b-0) (lambda (a-0) (lambda (arg-9145) (lambda (arg-9152) (case (vector-ref arg-9145 0) ((0) (let ((e-7 (vector-ref arg-9145 1))) (vector 0 e-7))) (else (let ((e-7 (vector-ref arg-9145 1))) (case (vector-ref arg-9152 0) ((1) (let ((e-8 (vector-ref arg-9152 1))) (vector 1 (e-7 e-8)))) (else (let ((e-11 (vector-ref arg-9152 1))) (vector 0 e-11)))))))))))))))) (let ((e-9 (vector-ref sc3 0))) e-9)) (let ((sc3 (Builtin-snd (cons (let ((e-8 (car arg-1))) (let ((e-11 (vector-ref e-8 0))) e-11)) (vector (lambda (b-0) (lambda (a-0) (lambda (func-0) (lambda (arg-8438) (case (vector-ref arg-8438 0) ((0) (let ((e-7 (vector-ref arg-8438 1))) (vector 0 e-7))) (else (let ((e-7 (vector-ref arg-8438 1))) (vector 1 (func-0 e-7))))))))) (lambda (a-0) (lambda (arg-9139) (vector 1 arg-9139))) (lambda (b-0) (lambda (a-0) (lambda (arg-9145) (lambda (arg-9152) (case (vector-ref arg-9145 0) ((0) (let ((e-7 (vector-ref arg-9145 1))) (vector 0 e-7))) (else (let ((e-7 (vector-ref arg-9145 1))) (case (vector-ref arg-9152 0) ((1) (let ((e-8 (vector-ref arg-9152 1))) (vector 1 (e-7 e-8)))) (else (let ((e-11 (vector-ref arg-9152 1))) (vector 0 e-11)))))))))))))))) (let ((e-9 (vector-ref sc3 0))) e-9))) u--func arg-8437))))) (lambda (u--a) (lambda (arg-9139) (PreludeC-45InterfacesC-45Applicative-u--pure_Applicative_ComposeC-40C-40C-46C-32C-36fC-41C-32C-36gC-41 (cons (let ((e-8 (car arg-1))) (let ((e-11 (vector-ref e-8 0))) e-11)) (vector (lambda (u--b) (lambda (a-0) (lambda (u--func) (lambda (arg-8437) (case (vector-ref arg-8437 0) ((0) (let ((e-7 (vector-ref arg-8437 1))) (vector 0 e-7))) (else (let ((e-7 (vector-ref arg-8437 1))) (vector 1 (u--func e-7))))))))) (lambda (a-0) (lambda (arg-9140) (vector 1 arg-9140))) (lambda (u--b) (lambda (a-0) (lambda (arg-9145) (lambda (arg-9152) (case (vector-ref arg-9145 0) ((0) (let ((e-7 (vector-ref arg-9145 1))) (vector 0 e-7))) (else (let ((e-7 (vector-ref arg-9145 1))) (case (vector-ref arg-9152 0) ((1) (let ((e-8 (vector-ref arg-9152 1))) (vector 1 (e-7 e-8)))) (else (let ((e-11 (vector-ref arg-9152 1))) (vector 0 e-11))))))))))))) arg-9139))) (lambda (u--b) (lambda (u--a) (lambda (arg-9145) (lambda (arg-9152) (PreludeC-45InterfacesC-45Applicative-u--C-60C-42C-62_Applicative_ComposeC-40C-40C-46C-32C-36fC-41C-32C-36gC-41 (cons (let ((e-8 (car arg-1))) (let ((e-11 (vector-ref e-8 0))) e-11)) (vector (lambda (b-0) (lambda (a-0) (lambda (u--func) (lambda (arg-8437) (case (vector-ref arg-8437 0) ((0) (let ((e-7 (vector-ref arg-8437 1))) (vector 0 e-7))) (else (let ((e-7 (vector-ref arg-8437 1))) (vector 1 (u--func e-7))))))))) (lambda (a-0) (lambda (arg-9139) (vector 1 arg-9139))) (lambda (b-0) (lambda (a-0) (lambda (arg-9146) (lambda (arg-9153) (case (vector-ref arg-9146 0) ((0) (let ((e-7 (vector-ref arg-9146 1))) (vector 0 e-7))) (else (let ((e-7 (vector-ref arg-9146 1))) (case (vector-ref arg-9153 0) ((1) (let ((e-8 (vector-ref arg-9153 1))) (vector 1 (e-7 e-8)))) (else (let ((e-11 (vector-ref arg-9153 1))) (vector 0 e-11))))))))))))) arg-9145 arg-9152)))))) (SystemC-45FileC-45ReadWrite-fSeekLine arg-1 arg-5) (SystemC-45FileC-45ReadWrite-readLinesOnto arg-1 arg-2 e-6 (box e-0) arg-5)))))) (else (let ((e-7 (car arg-1))) (let ((e-10 (vector-ref e-7 0))) (let ((e-12 (vector-ref e-10 1))) ((e-12 'erased) (vector 1 (cons 1 (PreludeC-45TypesC-45List-reverse arg-2)))))))))))))))))
...
(define SystemC-45Info-isWindows(blodwen-lazy (lambda () (PreludeC-45Types-elem (vector (lambda (u--acc) (lambda (u--elem) (lambda (u--func) (lambda (u--init) (lambda (u--input) (PreludeC-45Types-u--foldr_Foldable_List u--func u--init u--input)))))) (lambda (u--elem) (lambda (u--acc) (lambda (u--func) (lambda (u--init) (lambda (u--input) (PreludeC-45Types-u--foldl_Foldable_List u--func u--init u--input)))))) (lambda (u--elem) (lambda (arg-10120) (PreludeC-45Types-u--null_Foldable_List arg-10120))) (lambda (u--elem) (lambda (u--acc) (lambda (u--m) (lambda (i_con-0) (lambda (u--funcM) (lambda (u--init) (lambda (u--input) (PreludeC-45Types-u--foldlM_Foldable_List i_con-0 u--funcM u--init u--input)))))))) (lambda (u--elem) (lambda (arg-10149) arg-10149)) (lambda (u--a) (lambda (u--m) (lambda (i_con-0) (lambda (u--f) (lambda (arg-10163) (PreludeC-45Types-u--foldMap_Foldable_List i_con-0 u--f arg-10163))))))) (cons (lambda (arg-528) (lambda (arg-531) (PreludeC-45EqOrd-u--C-61C-61_Eq_String arg-528 arg-531))) (lambda (arg-538) (lambda (arg-541) (PreludeC-45EqOrd-u--C-47C-61_Eq_String arg-538 arg-541)))) (SystemC-45Info-os) (cons "windows" (cons "mingw32" (cons "cygwin32" '())))))))
...
(PrimIO-unsafePerformIO (lambda (eta-0) (Chapter_11C-45Section_3C-45ArithCmd-mainShell eta-0)))  (collect 4)
