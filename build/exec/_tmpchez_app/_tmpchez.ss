...
(define csegen-24(blodwen-lazy (lambda () (vector (lambda (u--b) (lambda (u--a) (lambda (u--func) (lambda (arg-8437) (lambda (eta-0) (PreludeC-45IO-u--map_Functor_IO u--func arg-8437 eta-0)))))) (lambda (u--a) (lambda (arg-9139) (lambda (eta-0) arg-9139))) (lambda (u--b) (lambda (u--a) (lambda (arg-9145) (lambda (arg-9152) (lambda (eta-0) (let ((act-17 (arg-9145 eta-0))) (let ((act-16 (arg-9152 eta-0))) (act-17 act-16))))))))))))
(define csegen-27(blodwen-lazy (lambda () (lambda (u--b) (lambda (u--a) (lambda (arg-9620) (lambda (arg-9623) (lambda (eta-0) (let ((act-24 (arg-9620 eta-0))) ((arg-9623 act-24) eta-0))))))))))
(define csegen-31(blodwen-lazy (lambda () (cons (vector (csegen-24) (csegen-27) (lambda (u--a) (lambda (arg-9634) (lambda (eta-0) (let ((act-51 (arg-9634 eta-0))) (act-51 eta-0)))))) (lambda (u--a) (lambda (arg-10871) arg-10871))))))
(define csegen-32(blodwen-lazy (lambda () (PreludeC-45IO-getLine (csegen-31)))))
(define csegen-35(blodwen-lazy (lambda () (vector (csegen-24) (csegen-27) (lambda (u--a) (lambda (arg-9634) (lambda (eta-0) (let ((act-29 (arg-9634 eta-0))) (act-29 eta-0)))))))))
...
(define Chapter_13C-45Section_2C-45Exercises-tryNegate (lambda (arg-0) (cond ((equal? arg-0 0) (Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62 (vector 4 "Fewer than one item on the stack\xa;") (lambda () (Chapter_13C-45Section_2C-45Exercises-stackCalc arg-0))))(else (let ((e-0 (- arg-0 1))) (Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62 (Chapter_13C-45Section_2C-45Exercises-doNegate) (lambda () (Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62C-61 (vector 2 ) (lambda (u--result) (lambda () (Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62 (vector 4 (string-append (PreludeC-45Show-u--show_Show_Integer u--result) "\xa;")) (lambda () (Chapter_13C-45Section_2C-45Exercises-stackCalc (+ e-0 1))))))))))))))
(define Chapter_13C-45Section_2C-45Exercises-tryDuplicate (lambda (arg-0) (cond ((equal? arg-0 0) (Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62 (vector 4 "Fewer than one item on the stack\xa;") (lambda () (Chapter_13C-45Section_2C-45Exercises-stackCalc arg-0))))(else (let ((e-0 (- arg-0 1))) (Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62C-61 (Chapter_13C-45Section_2C-45Exercises-doDuplicate) (lambda (u--duplicated) (lambda () (Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62 (vector 4 (string-append "Duplicated " (string-append (PreludeC-45Show-u--show_Show_Integer u--duplicated) "\xa;"))) (lambda () (Chapter_13C-45Section_2C-45Exercises-stackCalc (+ (+ e-0 1) 1))))))))))))
(define Chapter_13C-45Section_2C-45Exercises-tryDiscard (lambda (arg-0) (cond ((equal? arg-0 0) (Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62 (vector 4 "Fewer than one item on the stack\xa;") (lambda () (Chapter_13C-45Section_2C-45Exercises-stackCalc arg-0))))(else (let ((e-0 (- arg-0 1))) (Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62C-61 (Chapter_13C-45Section_2C-45Exercises-doDiscard) (lambda (u--oldTop) (lambda () (Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62 (vector 4 (string-append "Discarded " (string-append (PreludeC-45Show-u--show_Show_Integer u--oldTop) "\xa;"))) (lambda () (Chapter_13C-45Section_2C-45Exercises-stackCalc e-0)))))))))))
(define Chapter_13C-45Section_2C-45Exercises-tryBinaryOp (lambda (arg-0 arg-1) (cond ((equal? arg-1 0) (Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62 (vector 4 "Fewer than two items on the stack\xa;") (lambda () (Chapter_13C-45Section_2C-45Exercises-stackCalc arg-1))))(else (let ((e-0 (- arg-1 1))) (cond ((equal? e-0 0) (Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62 (vector 4 "Fewer than two items on the stack\xa;") (lambda () (Chapter_13C-45Section_2C-45Exercises-stackCalc arg-1))))(else (let ((e-1 (- e-0 1))) (Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62 (Chapter_13C-45Section_2C-45Exercises-doBinaryOp arg-0) (lambda () (Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62C-61 (vector 2 ) (lambda (u--result) (lambda () (Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62 (vector 4 (string-append (PreludeC-45Show-u--show_Show_Integer u--result) "\xa;")) (lambda () (Chapter_13C-45Section_2C-45Exercises-stackCalc (+ e-1 1)))))))))))))))))
(define Chapter_13C-45Section_2C-45Exercises-strToInput (lambda (arg-0) (cond ((equal? arg-0 "") '()) ((equal? arg-0 "add") (box (vector 1 ))) ((equal? arg-0 "subtract") (box (vector 2 ))) ((equal? arg-0 "multiply") (box (vector 3 ))) ((equal? arg-0 "negate") (box (vector 4 ))) ((equal? arg-0 "discard") (box (vector 5 ))) ((equal? arg-0 "duplicate") (box (vector 6 )))(else (let ((sc0 (PreludeC-45Interfaces-all (vector (lambda (u--acc) (lambda (u--elem) (lambda (u--func) (lambda (u--init) (lambda (u--input) (PreludeC-45Types-u--foldr_Foldable_List u--func u--init u--input)))))) (lambda (u--elem) (lambda (u--acc) (lambda (u--func) (lambda (u--init) (lambda (u--input) (PreludeC-45Types-u--foldl_Foldable_List u--func u--init u--input)))))) (lambda (u--elem) (lambda (arg-10120) (PreludeC-45Types-u--null_Foldable_List arg-10120))) (lambda (u--elem) (lambda (u--acc) (lambda (u--m) (lambda (i_con-0) (lambda (u--funcM) (lambda (u--init) (lambda (u--input) (PreludeC-45Types-u--foldlM_Foldable_List i_con-0 u--funcM u--init u--input)))))))) (lambda (u--elem) (lambda (arg-10149) arg-10149)) (lambda (u--a) (lambda (u--m) (lambda (i_con-0) (lambda (u--f) (lambda (arg-10163) (PreludeC-45Types-u--foldMap_Foldable_List i_con-0 u--f arg-10163))))))) (lambda (eta-0) (PreludeC-45Types-isDigit eta-0)) (PreludeC-45Types-fastUnpack arg-0)))) (cond ((equal? sc0 1) (box (vector 0 (PreludeC-45Cast-u--cast_Cast_String_Integer arg-0)))) (else '())))))))
(define Chapter_13C-45Section_2C-45Exercises-stackCalc (lambda (arg-0) (Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62 (vector 4 "> ") (lambda () (Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62C-61 (vector 3 ) (lambda (u--input) (let ((sc0 (Chapter_13C-45Section_2C-45Exercises-strToInput u--input))) (if (null? sc0) (lambda () (Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62 (vector 4 "Invalid input\xa;") (lambda () (Chapter_13C-45Section_2C-45Exercises-stackCalc arg-0)))) (let ((e-2 (unbox sc0))) (case (vector-ref e-2 0) ((0) (let ((e-3 (vector-ref e-2 1))) (lambda () (Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62 (vector 0 e-3) (lambda () (Chapter_13C-45Section_2C-45Exercises-stackCalc (+ arg-0 1))))))) ((1) (lambda () (Chapter_13C-45Section_2C-45Exercises-tryBinaryOp (lambda (eta-0) (lambda (eta-1) (+ eta-0 eta-1))) arg-0))) ((2) (lambda () (Chapter_13C-45Section_2C-45Exercises-tryBinaryOp (lambda (eta-0) (lambda (eta-1) (- eta-0 eta-1))) arg-0))) ((3) (lambda () (Chapter_13C-45Section_2C-45Exercises-tryBinaryOp (lambda (eta-0) (lambda (eta-1) (* eta-0 eta-1))) arg-0))) ((4) (lambda () (Chapter_13C-45Section_2C-45Exercises-tryNegate arg-0))) ((5) (lambda () (Chapter_13C-45Section_2C-45Exercises-tryDiscard arg-0))) (else (lambda () (Chapter_13C-45Section_2C-45Exercises-tryDuplicate arg-0)))))))))))))
(define Chapter_13C-45Section_2C-45Exercises-runStack (lambda (arg-3 arg-4) (case (vector-ref arg-4 0) ((0) (let ((e-20 (vector-ref arg-4 1))) (lambda (eta-0) (cons (vector 0 ) (cons e-20 arg-3)))))(else (if (null? arg-3) (case (vector-ref arg-4 0) ((3) (lambda (eta-0) (let ((act-24 ((csegen-32) eta-0))) (cons act-24 arg-3)))) ((4) (let ((e-2 (vector-ref arg-4 1))) (PreludeC-45Interfaces-C-62C-62 (csegen-35) (PreludeC-45IO-putStr (csegen-31) e-2) (lambda () (lambda (eta-0) (cons (vector 0 ) arg-3)))))) ((5) (let ((e-5 (vector-ref arg-4 1))) (lambda (eta-0) (cons e-5 arg-3)))) (else (let ((e-11 (vector-ref arg-4 1))) (let ((e-12 (vector-ref arg-4 2))) (lambda (eta-0) (let ((act-24 ((Chapter_13C-45Section_2C-45Exercises-runStack arg-3 e-11) eta-0))) (let ((e-2 (car act-24))) (let ((e-3 (cdr act-24))) ((Chapter_13C-45Section_2C-45Exercises-runStack e-3 (e-12 e-2)) eta-0))))))))) (let ((e-15 (car arg-3))) (let ((e-16 (cdr arg-3))) (case (vector-ref arg-4 0) ((1) (lambda (eta-0) (cons e-15 e-16))) ((2) (lambda (eta-0) (cons e-15 (cons e-15 e-16))))(else (case (vector-ref arg-4 0) ((3) (lambda (eta-0) (let ((act-24 ((csegen-32) eta-0))) (cons act-24 arg-3)))) ((4) (let ((e-2 (vector-ref arg-4 1))) (PreludeC-45Interfaces-C-62C-62 (csegen-35) (PreludeC-45IO-putStr (csegen-31) e-2) (lambda () (lambda (eta-0) (cons (vector 0 ) arg-3)))))) ((5) (let ((e-5 (vector-ref arg-4 1))) (lambda (eta-0) (cons e-5 arg-3)))) (else (let ((e-11 (vector-ref arg-4 1))) (let ((e-12 (vector-ref arg-4 2))) (lambda (eta-0) (let ((act-24 ((Chapter_13C-45Section_2C-45Exercises-runStack arg-3 e-11) eta-0))) (let ((e-2 (car act-24))) (let ((e-3 (cdr act-24))) ((Chapter_13C-45Section_2C-45Exercises-runStack e-3 (e-12 e-2)) eta-0))))))))))))))))))
(define Chapter_13C-45Section_2C-45Exercises-run (lambda (arg-1 arg-2 arg-3 ext-0) (if (null? arg-1) (vector 0 ) (let ((e-0 (unbox arg-1))) (case (vector-ref arg-3 0) ((0) (let ((e-4 (vector-ref arg-3 1))) (let ((e-5 (vector-ref arg-3 2))) (let ((act-24 ((Chapter_13C-45Section_2C-45Exercises-runStack arg-2 e-4) ext-0))) (let ((e-2 (car act-24))) (let ((e-3 (cdr act-24))) (Chapter_13C-45Section_2C-45Exercises-run (e-0) e-3 ((e-5 e-2)) ext-0))))))) (else (let ((e-8 (vector-ref arg-3 1))) (let ((e-9 (vector-ref arg-3 2))) (let ((act-24 ((Chapter_13C-45Section_2C-45Exercises-runStack arg-2 e-8) ext-0))) (let ((e-3 (cdr act-24))) (Chapter_13C-45Section_2C-45Exercises-run (e-0) e-3 (e-9) ext-0)))))))))))
(define Chapter_13C-45Section_2C-45Exercises-main (lambda (ext-0) (Chapter_13C-45Section_2C-45Exercises-run (Chapter_13C-45Section_2C-45Exercises-forever) '() (Chapter_13C-45Section_2C-45Exercises-stackCalc 0) ext-0)))
(define Chapter_13C-45Section_2C-45Exercises-forever(blodwen-lazy (lambda () (box (lambda () (Chapter_13C-45Section_2C-45Exercises-forever))))))
(define Chapter_13C-45Section_2C-45Exercises-doNegate(blodwen-lazy (lambda () (vector 6 (vector 1 ) (lambda (u--val) (vector 0 (- 0 u--val)))))))
(define Chapter_13C-45Section_2C-45Exercises-doDuplicate(blodwen-lazy (lambda () (vector 6 (vector 2 ) (lambda (u--top) (Chapter_13C-45Section_2C-45Exercises-C-62C-62 (vector 0 u--top) (lambda () (vector 5 u--top))))))))
(define Chapter_13C-45Section_2C-45Exercises-doDiscard(blodwen-lazy (lambda () (vector 6 (vector 1 ) (lambda (u--top) (vector 5 u--top))))))
(define Chapter_13C-45Section_2C-45Exercises-doBinaryOp (lambda (arg-1) (vector 6 (vector 1 ) (lambda (u--val1) (vector 6 (vector 1 ) (lambda (u--val2) (vector 0 ((arg-1 u--val2) u--val1))))))))
(define Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62C-61 (lambda (ext-0 ext-1) (vector 0 ext-0 ext-1)))
(define Chapter_13C-45Section_2C-45ExercisesC-45StackDo-C-62C-62 (lambda (ext-0 ext-1) (vector 1 ext-0 ext-1)))
(define Chapter_13C-45Section_2C-45Exercises-C-62C-62 (lambda (arg-5 arg-6) (vector 6 arg-5 (lambda (_-1691) (arg-6)))))
...
(PrimIO-unsafePerformIO (lambda (eta-0) (Chapter_13C-45Section_2C-45Exercises-main eta-0)))  (collect 4)
