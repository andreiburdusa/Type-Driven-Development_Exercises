#!/nix/store/lx7vf825j55ggfawj019jknwmi9k8yfc-chez-scheme-9.5.4/bin/scheme --program

; @generated by Idris 0.5.0, Chez backend
(import (chezscheme))
(case (machine-type)
...
(define csegen-15(blodwen-lazy (lambda () (vector (csegen-3) (csegen-10) (lambda (u--a) (lambda (arg-896) (lambda (eta-0) (let ((act-29 (arg-896 eta-0))) (act-29 eta-0)))))))))
(define csegen-1(blodwen-lazy (lambda () (cons (vector (csegen-3) (csegen-10) (lambda (u--a) (lambda (arg-896) (lambda (eta-0) (let ((act-51 (arg-896 eta-0))) (act-51 eta-0)))))) (lambda (u--a) (lambda (arg-7021) arg-7021))))))
...
(define Main-countdown (lambda (arg-0) (cond ((equal? arg-0 0) (PreludeC-45IO-putStrLn (csegen-1) "Lift off!"))(else (let ((e-0 (- arg-0 1))) (PreludeC-45Interfaces-C-62C-62 (csegen-15) (PreludeC-45IO-putStrLn (csegen-1) (PreludeC-45Show-u--show_Show_Nat (+ 1 e-0))) (lambda () (PreludeC-45Interfaces-C-62C-62 (csegen-15) (System-usleep (csegen-1) (blodwen-toSignedInt 1000000 63) 0) (lambda () (Main-countdown e-0))))))))))
...
(PrimIO-unsafePerformIO (Main-countdown ((lambda (succ-4) (+ 1 succ-4)) ((lambda (succ-3) (+ 1 succ-3)) ((lambda (succ-2) (+ 1 succ-2)) ((lambda (succ-1) (+ 1 succ-1)) ((lambda (succ-0) (+ 1 succ-0)) 0)))))))(collect 4)
